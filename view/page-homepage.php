...
<div class="flex bg-gray-900">
    ...
    <button id="tb1" class="tab-button rounded ml-12 mr-12 py-2 px-24 text-gray-400 bg-gray-900 text-sm" onclick="openTab(this.id, 'tc1')">Realta di riferimento</button>
    <button id="tb2" class="tab-button rounded py-2 px-24 text-gray-400 bg-gray-900 text-sm" onclick="openTab(this.id, 'tc2')">Schema concettuale</button>
    <button id="tb3" class="tab-button rounded ml-12 mr-12 py-2 px-24 text-gray-400 bg-gray-900 text-sm" onclick="openTab(this.id, 'tc3')">Schema logico e fisico</button>
    <div class="flex-1"></div>
</div>
<div class="p-1 bg-gray-900"></div>
<div id="tc1" class="tab-content hidden py-2">
...
<div id="tc2" class="tab-content hidden py-2">
...
<div id="tc3" class="tab-content hidden py-2">
