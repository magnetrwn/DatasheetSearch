  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    <div class="md:col-span-2">
      <h1 class="text-2xl font-bold mb-4">
        <?php 
          if(strlen(strstr($detaildata['cpalias'], ",", true)) > 0)
            echo strstr($detaildata['cpalias'], ",", true).": ".$detaildata['dsnome']; 
          else
            echo $detaildata['cpalias'].": ".$detaildata['dsnome']; 
        ?></h1>
      ...
      <div class="flex flex-wrap mb-8">
        ...
        <div class="mt-8 text-sm w-full md:w-1/2 lg:w-1/3">
          ...
          <a href="dynamic/ds/<?php echo strtr($detaildata['dsnome'].$detaildata['dsver'], ' ?/&=', '_'); ?>.pdf" class="text-lg text-blue-500 hover:underline">Scarica Datasheet</a>
        </div>
      </div>
    ...
    <div>
      <img src="<?php echo $detaildata['icona']; ?>" alt="Immagine package" class="mb-4 w-48 2xl:w-72">
      <div class="rounded bg-gray-900 p-4 pb-6">
        ...
        <a href="https://datasheetspdf.com/datasheet/search.php?sWord=<?php echo $detaildata['dsnome']; ?>" class="px-5 py-2 rounded bg-violet-400 text-gray-900">Cercalo su DatasheetsPDF</a>
      </div>
    </div>
  </div>
</div>
